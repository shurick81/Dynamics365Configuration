...
) | % { Save-Dynamics365Resource -Resource $_ -TargetDirectory C:\Istall\Dynamics\$_ }
...
@(
    ...
    "CRM2016LanguagePackUkr",
    "CRM2016LanguagePackVit"
) | % { Install-Dynamics365Language -MediaDir C:\Istall\Dynamics\$_ }
Install-Dynamics365Update -MediaDir C:\Istall\Dynamics\CRM2016Update01 -InstallAccount $CRMInstallAccountCredential
Install-Dynamics365Update -MediaDir C:\Istall\Dynamics\CRM2016ServicePack1 -InstallAccount $CRMInstallAccountCredential
Install-Dynamics365Update -MediaDir C:\Istall\Dynamics\CRM2016ServicePack1Update01 -InstallAccount $CRMInstallAccountCredential
Install-Dynamics365Update -MediaDir C:\Istall\Dynamics\CRM2016ServicePack2 -InstallAccount $CRMInstallAccountCredential
Install-Dynamics365Update -MediaDir C:\Istall\Dynamics\CRM2016ServicePack2Update01 -InstallAccount $CRMInstallAccountCredential
