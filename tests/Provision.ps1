$serverUpdateResource = "Dynamics365Server91Update19Enu"
$reportingExtensionsUpdateResource = "Dynamics365Server91ReportingExtensionsUpdate19Enu"
$updatedVersion = "9.1.19"
$updatedVersionFull = "9.1.19.10"
$KbId = "KB5028376"
