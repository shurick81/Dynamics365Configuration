$serverUpdateResource = "Dynamics365Server91Update26Enu"
$reportingExtensionsUpdateResource = "Dynamics365Server91ReportingExtensionsUpdate26Enu"
$updatedVersion = "9.1.26"
$updatedVersionFull = "9.1.26.23"
$KbId = "KB5035697"
