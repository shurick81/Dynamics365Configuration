...
try {
    ...
    Invoke-Command "$env:COMPUTERNAME.$domainName" -Credential $CRMInstallAccountCredential -Authentication CredSSP {
        ...
        Install-Dynamics365Server `
            ...
            -Patch C:\Install\Dynamics\Dynamics365Server91Update02Enu\Server_KB4618808_amd64_1033.msp `
...
If ( $msCRMRegistryValues ) {
    ...
    if ( $installedVersion ) {
        if ( $installedVersion -ne [version]"9.1.2.2" ) {
...
try {
    if ( $dbHostName -eq $env:COMPUTERNAME ) {
        ...
        $patchPath = "C:\Install\Dynamics\Dynamics365Server91ReportingExtensionsUpdate02Enu\Srs_KB4618808_amd64_1033.msp";
    } else {
        $mediaDir = "\\$env:COMPUTERNAME\c$\Install\Dynamics\Dynamics365Server90RTMEnu\SrsDataConnector";
        $patchPath = "\\$env:COMPUTERNAME\c$\Install\Dynamics\Dynamics365Server91ReportingExtensionsUpdate02Enu\Srs_KB4618808_amd64_1033.msp";
    }
