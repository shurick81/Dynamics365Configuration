$serverUpdateResource = "Dynamics365Server91Update18Enu"
$reportingExtensionsUpdateResource = "Dynamics365Server91ReportingExtensionsUpdate18Enu"
$updatedVersion = "9.1.18"
$updatedVersionFull = "9.1.18.22"
$KbId = "KB5026501"
