$serverUpdateResource = "Dynamics365Server91Update21Enu"
$reportingExtensionsUpdateResource = "Dynamics365Server91ReportingExtensionsUpdate21Enu"
$updatedVersion = "9.1.21"
$updatedVersionFull = "9.1.21.5"
$KbId = "KB5030608"
