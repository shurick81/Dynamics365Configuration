$serverUpdateResource = "Dynamics365Server91Update25Enu"
$reportingExtensionsUpdateResource = "Dynamics365Server91ReportingExtensionsUpdate25Enu"
$updatedVersion = "9.1.25"
$updatedVersionFull = "9.1.25.17"
$KbId = "KB5035110"
