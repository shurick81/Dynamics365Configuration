$serverUpdateResource = "Dynamics365Server91Update20Enu"
$reportingExtensionsUpdateResource = "Dynamics365Server91ReportingExtensionsUpdate20Enu"
$updatedVersion = "9.1.20"
$updatedVersionFull = "9.1.20.11"
$KbId = "KB5029397"
