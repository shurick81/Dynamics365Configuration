...
try {
    ...
    Invoke-Command "$env:COMPUTERNAME.$domainName" -Credential $CRMInstallAccountCredential -Authentication CredSSP {
        ...
        Install-Dynamics365Server `
            ...
            -Patch C:\Install\Dynamics\Dynamics365Server91Update06Enu\Server_KB4618798_amd64_1033.msp `
...
try {
    if ( $dbHostName -eq $env:COMPUTERNAME ) {
        ...
        $patchPath = "C:\Install\Dynamics\Dynamics365Server91ReportingExtensionsUpdate06Enu\Srs_KB4618798_amd64_1033.msp";
    } else {
        $mediaDir = "\\$env:COMPUTERNAME\c$\Install\Dynamics\Dynamics365Server90RTMEnu\SrsDataConnector";
        $patchPath = "\\$env:COMPUTERNAME\c$\Install\Dynamics\Dynamics365Server91ReportingExtensionsUpdate06Enu\Srs_KB4618798_amd64_1033.msp";
    }
